...
document.write('\
            <div id="footerGroup">\
            <div class="notlast_footerButton" id="footerButton"><div><a href="mailto:info@educationalresource.com">\
                <div><div><img class="footerIcon" src="img/btn/btn_email.png" /></div><div>info@educationalresource.com</div></div></a></div></div>\
            <div class="notlast_footerButton" id="footerButton"><div><a href="tel:17328420202">\
                <div><div><img class="footerIcon" src="img/btn/btn_phone.png" /></div><div>732.842.0202</div></div></a></div></div>\
            <div id="footerButton">\
